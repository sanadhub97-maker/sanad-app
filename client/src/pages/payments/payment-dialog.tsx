                  ...
                  render={({ field }) => (
                    <Select value={field.value} onValueChange={field.onChange}>
                      ...
                      <SelectContent className="rounded-xl shadow-xl">
                        ...
                        {/* An older payment may use a category no longer offered — keep it selectable when editing. */}
                        {field.value && !(PAYMENT_CATEGORIES as readonly string[]).includes(field.value) && (
                          <SelectItem value={field.value}>{t(`paymentCategories.${field.value}`)}</SelectItem>
                        )}
                      </SelectContent>
                    </Select>
                  )}
